...
INTENT_KEYWORDS: dict[QueryIntent, Set[str]] = {
    "debt_payoff": {
        ...
        "balance", "owe", "owing", "paying down", "debt free", "minimum payment",
        "student loan", "car loan", "mortgage", "personal loan", "credit",
    },
    "savings": {
        "save", "saving", "savings", "emergency fund", "nest egg", "put away",
        "set aside", "rainy day", "savings account", "high yield", "hysa",
    },
    "spending_optimization": {
        "spending", "spend", "cut back", "reduce", "trim", "budget",
        "too much", "overspending", "expenses", "cut costs", "waste",
        "where am i spending", "spending habits", "track spending",
    },
    "investment": {
        "invest", "investing", "investment", "stocks", "bonds", "etf",
        "index fund", "brokerage", "portfolio", "returns", "growth",
        "compound", "market", "401k", "ira", "roth",
    },
    "retirement": {
        "retirement", "retire", "retiring", "pension", "social security",
        "fire", "financial independence", "early retirement", "401k",
        "ira", "roth ira", "traditional ira", "retirement account",
    },
    "emergency_fund": {
        "emergency fund", "emergency savings", "rainy day fund",
        "3 months", "6 months", "cushion", "safety net", "unexpected expenses",
    },
    "major_purchase": {
        "house", "home", "down payment", "car", "vehicle", "wedding",
        "vacation", "travel", "education", "tuition", "buy", "purchase",
        "afford", "save for", "saving for",
    },
    "debt_vs_savings": {
        "debt or save", "save or pay", "pay off or save", "debt vs savings",
        "should i pay", "should i save", "prioritize",
    },
    "general_advice": {
        "help", "advice", "tips", "suggestions", "recommend", "what should i",
        "how should i", "best way", "optimize", "improve",
    },
}
...
CONCERN_KEYWORDS: dict[str, Set[str]] = {
    "job_security": {
        "job security", "layoff", "laid off", "unemployment", "job loss",
        "stable job", "unstable income", "variable income", "freelance",
        "contract work", "gig economy",
    },
    "debt_burden": {
        "debt burden", "overwhelmed", "drowning in debt", "can't keep up",
        "high interest", "multiple debts", "debt stress", "collection",
    },
    "retirement_readiness": {
        "behind on retirement", "not saving enough", "catch up",
        "will i have enough", "retirement ready", "retire on time",
    },
    "healthcare_costs": {
        "healthcare", "medical", "health insurance", "hsa", "deductible",
        "medical bills", "health costs",
    },
    "family_obligations": {
        "kids", "children", "college fund", "529", "childcare", "family",
        "parents", "elder care", "support",
    },
}
...
TIMEFRAME_KEYWORDS: dict[Timeframe, Set[str]] = {
    "immediate": {
        "now", "right now", "immediately", "this month", "today",
        "urgent", "asap", "quickly",
    },
    "short_term": {
        "soon", "this year", "next year", "1 year", "one year",
        "12 months", "6 months", "few months",
    },
    "medium_term": {
        "2 years", "3 years", "5 years", "couple years", "few years",
        "in a few years", "next few years",
    },
    "long_term": {
        "10 years", "20 years", "long term", "eventually", "someday",
        "retirement", "when i retire", "down the road", "future",
    },
}
...
def analyze_query(query: str) -> QueryAnalysis:
    ...
    needs_financial_philosophy = primary_intent in {
        "debt_vs_savings", "debt_payoff", "savings", "retirement",
    } or len(secondary_intents) > 0

    needs_goal_clarification = (
        primary_intent in {"major_purchase", "savings"} and not mentioned_goals
    )

    needs_timeline_clarification = (
        timeframe == "unspecified" and 
        primary_intent in {"savings", "major_purchase", "debt_payoff", "retirement"}
    )
