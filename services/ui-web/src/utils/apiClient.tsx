    ...
    try {
      ...
      if (error instanceof TypeError) {
        ...
        const errorMessage = isLocalhost
          ? `Unable to reach the API server at ${activeBaseUrl}. Ensure the server is running and reachable from this browser.`
          : `Unable to reach the API server at ${activeBaseUrl}. Please check that NEXT_PUBLIC_LIFEPATH_API_BASE_URL is correctly configured in your Vercel project settings.`;
